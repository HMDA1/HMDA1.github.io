...
$(document).ready(function () {
  ...
  $('.sidebar-nav li').on('click', function () {
    ...
    hasVelocity ?
      currentTarget.velocity('transition.slideUpOut',
  ...
  $('.post-toc a').on('click', function (e) {
    e.preventDefault();
    var targetSelector = NexT.utils.escapeSelector(this.getAttribute(
      'href'));
  ...
  var hasTOC = $tocContent.length > 0 && $tocContent.html().trim().length >
    0;
